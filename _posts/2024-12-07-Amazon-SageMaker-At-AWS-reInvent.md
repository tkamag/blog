...
1. **Amazon Redshift** is basically base on open-source **Postgres** database but it's completely rewritten and very cost efficient compared to traditional on-premises datawarehouse because customers here are not doing any maintenance of infrastructure, management at all.

> To summarize, **Redshift** it has a **massively  parallel processing architecture** but to put it in a very simple terms, **one job is broken into small jobs and it's distributed across different nodes
...
![Image Description]([https://site/photo.png](https://user-images.githubusercontent.com/14333637/214539972-bc2767d6-239a-41e9-9025-cdcf4804ee6b.png))
...
![Image Description]([https://site/photo.png](https://user-images.githubusercontent.com/14333637/214544314-8020a60f-a8b1-4aad-842b-7f5c02b4e179.png))
...
![Image Description]([https://site/photo.png](https://user-images.githubusercontent.com/14333637/214580461-5f1460b7-2886-4d51-9065-afc0c5c9aa6b.png))
...
### Item 4.1: Federated Query

![Image Description]([https://site/photo.png](https://user-images.githubusercontent.com/14333637/214615804-7305a6fd-752d-4969-b73d-80bd2690d828.png))
...
![Image Description](https://user-images.githubusercontent.com/14333637/214645477-e0f81dd0-e077-440e-bd80-c44c35bd7af3.png)
